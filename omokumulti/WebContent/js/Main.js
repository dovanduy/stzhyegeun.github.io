window.onRequireLoad = function() {
	...
	var create = function() {
		...
		window.stz_peer = new Peer({host: StzServerConfig.BASE_URL, path:'/api', port: 80, debug: 3, config: {'iceServers': [{url: 'stun:stun.1.google.com:19302'}, { url: 'turn:homeo@turn.bistri.com:80', username: 'homeo', credential: 'homeo'}]}});
