...
/**
* The WeaponP2 Plugin provides the ability to easily create a bullet pool and manager.
*
* Weapons fire {@link Phaser.BulletP2} objects, which are essentially Sprites with a few extra properties.
* The Bullets are enabled for {@link Phaser.Physics.P2JS P2 Physics}. They do not currently work with P2 Physics.
*
...
*/
Phaser.WeaponP2 = function (game, parent) {
    ...
    /**
     * If you've set {@link #bulletKillType} to `Phaser.WeaponP2.KILL_LIFESPAN` this controls the amount
    ...
    /**
     * If you've set {@link #bulletKillType} to `Phaser.WeaponP2.KILL_DISTANCE` this controls the distance
     ...
     * @private
     */
    this._bulletClass = Phaser.BulletP2;
     ...
     * @private
     */
    this._bulletKillType = Phaser.WeaponP2.KILL_WORLD_BOUNDS;
     ...
     * It's used in combination with {@link #bulletKillType} when that is set to either `Phaser.WeaponP2.KILL_WEAPON_BOUNDS`
     * or `Phaser.WeaponP2.KILL_STATIC_BOUNDS`. If you are not using either of these kill types then the bounds are ignored.
...
Phaser.WeaponP2.prototype = Object.create(Phaser.Plugin.prototype);
Phaser.WeaponP2.prototype.constructor = Phaser.WeaponP2;
...
* @type {integer}
*/
Phaser.WeaponP2.KILL_LIFESPAN = 1;
...
* @type {integer}
*/
Phaser.WeaponP2.KILL_DISTANCE = 2;
...
* @type {integer}
*/
Phaser.WeaponP2.KILL_WEAPON_BOUNDS = 3;
...
* @type {integer}
*/
Phaser.WeaponP2.KILL_CAMERA_BOUNDS = 4;
...
* @type {integer}
*/
Phaser.WeaponP2.KILL_WORLD_BOUNDS = 5;
...
* @type {integer}
*/
Phaser.WeaponP2.KILL_STATIC_BOUNDS = 6;
...
*
* @method Phaser.WeaponP2#createBullets
...
* @return {Phaser.WeaponP2} This Weapon instance.
*/
Phaser.WeaponP2.prototype.createBullets = function (quantity, key, frame, group) {
    ...
    if (!this.bullets)
    {
        ...
        //this.bullets = this.game.add.physicsGroup(Phaser.Physics.P2JS, group);
...
//        this.bullets.forEach(function(inItem) {
        	//this.game.physics.p2.enable(inItem, true);
        	//inItem.body.data.shapes[0].name = "bullet";
//        }, this);
        //this.bullets.setAll('body.data.shapes[0].name', "bullet");
...
*
* @method Phaser.WeaponP2#forEach
...
* @return {Phaser.WeaponP2} This Weapon instance.
*/
Phaser.WeaponP2.prototype.forEach = function (callback, callbackContext) {
...
*
* @method Phaser.WeaponP2#pauseAll
* @return {Phaser.WeaponP2} This Weapon instance.
*/
Phaser.WeaponP2.prototype.pauseAll = function () {

	// No sleep in P2 Physics
    //this.bullets.setAll('body.sleepState', false);
...
*
* @method Phaser.WeaponP2#resumeAll
* @return {Phaser.WeaponP2} This Weapon instance.
*/
Phaser.WeaponP2.prototype.resumeAll = function () {
...
/**
* Calls {@link Phaser.BulletP2#kill} on every in-flight bullet in this Weapon.
* Also re-enables their physics bodies, should they have been disabled via {@link #pauseAll}.
*
* @method Phaser.WeaponP2#killAll
* @return {Phaser.WeaponP2} This Weapon instance.
*/
Phaser.WeaponP2.prototype.killAll = function () {
...
*
* @method Phaser.WeaponP2#resetShots
* @param {integer} [newLimit] - Optionally set a new {@link #fireLimit}.
* @return {Phaser.WeaponP2} This Weapon instance.
*/
Phaser.WeaponP2.prototype.resetShots = function (newLimit) {
...
*
* @method Phaser.WeaponP2#destroy
*/
Phaser.WeaponP2.prototype.destroy = function () {
...
*
* @method Phaser.WeaponP2#update
* @protected
*/
Phaser.WeaponP2.prototype.update = function () {
    if (this._bulletKillType === Phaser.WeaponP2.KILL_WEAPON_BOUNDS)
    {
...
* Internal update method, called by the PluginManager.
*
* @method Phaser.WeaponP2#postRender
* @protected
*/
Phaser.WeaponP2.prototype.postRender = function () {
...
*
* @method Phaser.WeaponP2#trackSprite
...
* @return {Phaser.WeaponP2} This Weapon instance.
*/
Phaser.WeaponP2.prototype.trackSprite = function (sprite, offsetX, offsetY, trackRotation) {
...
*
* @method Phaser.WeaponP2#trackPointer
...
* @return {Phaser.WeaponP2} This Weapon instance.
*/
Phaser.WeaponP2.prototype.trackPointer = function (pointer, offsetX, offsetY) {
...
*
* @method Phaser.WeaponP2#fireMany
...
* @return {array} An array containing all of the fired Phaser.BulletP2 objects, if a launch was successful, otherwise an empty array.
*/
Phaser.WeaponP2.prototype.fireMany = function (positions, from) {
...
*
* @method Phaser.WeaponP2#fireOffset
...
* @return {Phaser.BulletP2} The fired bullet, if a launch was successful, otherwise `null`.
*/
Phaser.WeaponP2.prototype.fireOffset = function (offsetX, offsetY) {
...
* @return {Phaser.BulletP2} The fired bullet, if a launch was successful, otherwise `null`.
*/
Phaser.WeaponP2.prototype.fire = function (from, x, y, offsetX, offsetY) {
    ...
    if (bullet)
    {
        ...
        if (this.bulletKillType === Phaser.WeaponP2.KILL_LIFESPAN)
        {
...
*
* @method Phaser.WeaponP2#fireAtPointer
* @param {Phaser.Pointer} [pointer] - The Pointer to fire the bullet towards.
* @return {Phaser.BulletP2} The fired bullet if successful, null otherwise.
*/
Phaser.WeaponP2.prototype.fireAtPointer = function (pointer) {
...
* or from a Tracked Sprite or Pointer, if you have one set.
*
* @method Phaser.WeaponP2#fireAtSprite
* @param {Phaser.Sprite} [sprite] - The Sprite to fire the bullet towards.
* @return {Phaser.BulletP2} The fired bullet if successful, null otherwise.
*/
Phaser.WeaponP2.prototype.fireAtSprite = function (sprite) {
...
* or from a Tracked Sprite or Pointer, if you have one set.
*
* @method Phaser.WeaponP2#fireAtXY
...
* @return {Phaser.BulletP2} The fired bullet if successful, null otherwise.
*/
Phaser.WeaponP2.prototype.fireAtXY = function (x, y) {
...
*
* @method Phaser.WeaponP2#setBulletBodyOffset
...
* @return {Phaser.WeaponP2} The Weapon Plugin.
*/
Phaser.WeaponP2.prototype.setBulletBodyOffset = function (width, height, offsetX, offsetY, rotation) {
...
//    this._data.offsetY = offsetY;
    ...
    debugger;
    this.bullets.callAll('body.setRectangle', 'body', width, height, offsetX, offsetY, rotation);
...
*
* @method Phaser.WeaponP2#setBulletFrames
...
* @return {Phaser.WeaponP2} The Weapon Plugin.
*/
Phaser.WeaponP2.prototype.setBulletFrames = function (min, max, cycle, random) {
...
*
* @method Phaser.WeaponP2#addBulletAnimation
...
* @return {Phaser.WeaponP2} The Weapon Plugin.
*/
Phaser.WeaponP2.prototype.addBulletAnimation = function (name, frames, frameRate, loop, useNumericIndex) {
...
*/
Phaser.WeaponP2.prototype.debug = function (x, y, debugBodies) {
...
/**
* The Class of the bullets that are launched by this Weapon. Defaults to {@link Phaser.BulletP2}, but can be
...
*
* @name Phaser.WeaponP2#bulletClass
* @property {function} bulletClass
*/
Object.defineProperty(Phaser.WeaponP2.prototype, "bulletClass", {
...
*
* @name Phaser.WeaponP2#bulletKillType
* @property {integer} bulletKillType
*/
Object.defineProperty(Phaser.WeaponP2.prototype, "bulletKillType", {
    ...
    set: function (type) {
        ...
        switch (type)
        {
            case Phaser.WeaponP2.KILL_STATIC_BOUNDS:
            case Phaser.WeaponP2.KILL_WEAPON_BOUNDS:
                this.bulletBounds = this.bounds;
                break;

            case Phaser.WeaponP2.KILL_CAMERA_BOUNDS:
                this.bulletBounds = this.game.camera.view;
                break;

            case Phaser.WeaponP2.KILL_WORLD_BOUNDS:
...
*
* @name Phaser.WeaponP2#bulletCollideWorldBounds
* @property {boolean} bulletCollideWorldBounds
*/
Object.defineProperty(Phaser.WeaponP2.prototype, "bulletCollideWorldBounds", {
...
/**
* The x coordinate from which bullets are fired. This is the same as `WeaponP2.fireFrom.x`, and
* can be overridden by the {@link #fire} arguments.
*
* @name Phaser.WeaponP2#x
* @property {number} x
*/
Object.defineProperty(Phaser.WeaponP2.prototype, "x", {
...
/**
* The y coordinate from which bullets are fired. This is the same as `WeaponP2.fireFrom.y`, and
* can be overridden by the {@link #fire} arguments.
*
* @name Phaser.WeaponP2#y
* @property {number} y
*/
Object.defineProperty(Phaser.WeaponP2.prototype, "y", {
...
/**
* Create a new `Bullet` object. Bullets are used by the `Phaser.WeaponP2` class, and are normal Sprites,
* with a few extra properties in the data object to handle Weapon specific features.
*
* @class Phaser.BulletP2
* @constructor
...
*/
Phaser.BulletP2 = function (game, x, y, key, frame) {
...
Phaser.BulletP2.prototype = Object.create(Phaser.Sprite.prototype);
Phaser.BulletP2.prototype.constructor = Phaser.BulletP2;

/**
* Kills the Bullet, freeing it up for re-use by the Weapon bullet pool.
* Also dispatches the `WeaponP2.onKill` signal.
*
* @method Phaser.BulletP2#kill
* @memberof Phaser.BulletP2
*/
Phaser.BulletP2.prototype.kill = function () {
...
Phaser.BulletP2.prototype.distanceToXY = function(displayObject, x, y, world) {
...
*
* @method Phaser.BulletP2#update
* @memberof Phaser.BulletP2
*/
Phaser.BulletP2.prototype.update = function () {
    if (!this.exists)
    {
        return;
    }
    if (this.data.killType > Phaser.WeaponP2.KILL_LIFESPAN)
    {
        if (this.data.killType === Phaser.WeaponP2.KILL_DISTANCE)
        {
        	debugger;
            if (this.distanceToXY(this, this.data.fromX, this.data.fromY, true) > this.data.killDistance)
            {
                this.kill();
            }
        }
...
Phaser.GameObjectFactory.prototype.weaponP2 = function(quantity, key, frame, group, bulletClass) {
	var weapon = this.game.plugins.add(Phaser.WeaponP2);
