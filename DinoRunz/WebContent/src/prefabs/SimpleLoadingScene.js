...
function SimpleLoadingScene(aGame, aParent, aName, aAddToStage, aEnableBody, aPhysicsBodyType) {
	...
	var _txtProgress = this.game.add.text(360, 520, '1 / 4', {"font":"bold 45px Arial","fill":"#ffffff"}, this);
	_txtProgress.anchor.setTo(0.5, 0.5);
	
	var _iconLoading = this.game.add.sprite(360, 520, 'circle_loading', null, this);
	...
	var progressFontStyle = {fontSize: "45px", font: "blogger_sans_bold", fill: "#ffffff"};
