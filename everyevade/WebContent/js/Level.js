...
Level.prototype.preload = function() {
	...
	this.PlayerModel = Player(this.playerId + Object.keys(Player.list).length);
	this.PlayerModel.sprite = this.scene.fSpaceship;
};
...
Level.prototype.update = function() {
	...
	// event
	for (var playerIndex in Player.list) {
		Player.list[playerIndex].pressingLeft = this.cursors.left.isDown;
		Player.list[playerIndex].pressingRight = this.cursors.right.isDown;
		Player.list[playerIndex].pressingUp = this.cursors.up.isDown;
		Player.list[playerIndex].pressingDown = this.cursors.down.isDown;
	}
...
Level.prototype.updatePlayerView = function() {
	for (var playerIndex in Player.list) {
