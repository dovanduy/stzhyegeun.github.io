...
Phaser.Plugin.PopupManager = function(inGame, aParent, options) {
	...
	this.prePopupOpenCallback = null;
	this.postPopupOpenCallback = null;
...
Phaser.Plugin.PopupManager.prototype.popupOpen= function(){
	...
	var tween = this.inGame.add.tween(this.scene.scale).to({ x:1, y:1}, 50, 'Linear', true, 0);    
...
Phaser.Plugin.PopupManager.prototype.prePopupOpen= function(){
	...
	this.scene.scale.set(0.7, 0.7);
	
	this.isOpen = true;
	
	if(this.prePopupOpenCallback !== undefined && this.prePopupOpenCallback !== null){
		this.prePopupOpenCallback();
	}
};
...
Phaser.Plugin.PopupManager.prototype.postPopupOpen= function(){
	...
	if(this.postPopupOpenCallback !== undefined && this.postPopupOpenCallback !== null){
		this.postPopupOpenCallback();
	}
...
Phaser.Plugin.PopupManager.prototype.popupClose = function(){
	...
	var tween = this.inGame.add.tween(this.scene.scale).to({ x:0.9, y:0.9}, 50, 'Linear', true, 0); // nope  
	tween.onComplete.addOnce(function(){
		this.postPopupClose();
	}.bind(this));
};
