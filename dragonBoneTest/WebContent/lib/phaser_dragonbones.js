...
dragonBones.parseJSONAtlas = function(atlasJson,name,partsList){
    ...
    var subTextures = atlasJson.SubTexture;
    ...
    function createFrame(txData, p_partName){
        ...
        subTexture.x = txData.x;
        subTexture.y = txData.y;
        subTexture.width = txData.width;
        subTexture.height = txData.height;
        //
